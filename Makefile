...
install:
	...
	install -Dm644 share/lfs-linux/lfs-0.8C24-stock.manifest $(DATADIR)/lfs-linux/lfs-0.8C24-stock.manifest
	install -Dm644 share/lfs-linux/lfs-0.8C24-seed.manifest $(DATADIR)/lfs-linux/lfs-0.8C24-seed.manifest
	install -Dm644 share/lfs-linux/lfs-0.8C24-nested.manifest $(DATADIR)/lfs-linux/lfs-0.8C24-nested.manifest
