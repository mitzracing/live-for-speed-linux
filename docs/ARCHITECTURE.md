...
- exact local C23 predecessor: require its content-addressed protected baseline, then stage C24 and replace complete player-owned roots with `cp -a` metadata preservation before the atomic swap
